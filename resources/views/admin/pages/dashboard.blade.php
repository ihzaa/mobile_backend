            ...
            <div class="block block-rounded d-flex flex-column">
                <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                    <dl class="mb-0">
                        ...
                        <dd class="text-muted mb-0">Pasien <br> BPJS</dd>
                    </dl>
                    <div class="item item-rounded bg-body">
                        <i class="fas fa-hospital-user font-size-h3 text-primary"></i>
                    </div>
                </div>
            ...
            <div class="block block-rounded d-flex flex-column">
                <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                    <dl class="mb-0">
                        ...
                        <dd class="text-muted mb-0">Pasien <br> Rawat Inap</dd>
                    </dl>
                    <div class="item item-rounded bg-body">
                        <i class="fas fa-procedures font-size-h3 text-primary"></i>
                    </div>
                </div>
                <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm">
                    <a class="font-w500 d-flex align-items-center" href="javascript:void(0)">
            ...
            <div class="block block-rounded d-flex flex-column">
                <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                    <dl class="mb-0">
                        ...
                        <dd class="text-muted mb-0">Dokter</dd>
                    </dl>
                    <div class="item item-rounded bg-body">
                        <i class="fas fa-user-md font-size-h3 text-primary"></i>
                    </div>
                </div>
                <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm">
                    <a class="font-w500 d-flex align-items-center" href="javascript:void(0)">
        ...
        <div class="col-sm-6 col-xl-3">
            ...
            <div class="block block-rounded d-flex flex-column">
                <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                    <dl class="mb-0">
                        <dt class="font-size-h2 font-w700">45</dt>
                        <dd class="text-muted mb-0">Perawat</dd>
                    </dl>
                    <div class="item item-rounded bg-body">
                        <i class="fa fa-user-nurse font-size-h3 text-primary"></i>
                    </div>
                </div>
                <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm">
                    <a class="font-w500 d-flex align-items-center" href="javascript:void(0)">
        ...
        <div class="col-xl-8 d-flex flex-column">
            ...
            <div class="block block-rounded flex-grow-1 d-flex flex-column">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Kinerja Pegawai</h3>
